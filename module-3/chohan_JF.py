...
while True:  # Main game loop.
    ...
    # Include a notice that if the user gets a 2 or 7 on dice roll.
    total_roll = dice1 + dice2
    if total_roll == 2 or total_roll == 7:
        print(f"The total of the dice roll is {total_roll}. You get a 10 mon bonus!")
        purse +=10   # They get a 10 mon bonus.
